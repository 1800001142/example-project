import {hidemsg} from "@/crocus-origin/validate.js";
...
//     Mask = document.querySelector(".mask"), overlayPath = document.querySelector(".overlay-path"),
//     Header = document.querySelector(".header"), Logo = document.querySelector(".logo"),
//     rightHeader = document.querySelector(".right-header"), Language = document.querySelector(".language"),
//     searchBut = document.querySelector(".search-but"), formRowSearch = document.querySelector(".form-row-search"),
//     Navigation = document.querySelector(".navigation"), Nav = document.querySelector(".nav"),
//     mainMenu = document.querySelector(".main-menu"), navLi = document.querySelectorAll(".main-menu li"),
//     hasSub = document.querySelectorAll(".has-sub"), naItems = document.querySelectorAll(".nav-item"),
//     subItems = document.querySelectorAll(".sub-menu-drop"), overlayMenu = document.querySelector(".overlay-menu"),
//     logoMenu = document.querySelector(".logo-menu"), navClick = document.querySelector(".nav-click"),
...
var functionListerClick = function () {
    ...
    if (slickActiveIndex <= Math.max(slideBg.length, slideInfo.length)) {
        ...
        if (slideBgCurrent) slideBgCurrent.setAttribute("data-current", "");
        if (slideBgPrevious) slideBgPrevious.setAttribute("data-previous", "");
        if (slideBgNext) slideBgNext.setAttribute("data-next", "");
        if (slideInfoCurrent) slideInfoCurrent.setAttribute("data-current", "");
        if (slideInfoPrevious) slideInfoPrevious.setAttribute("data-previous", "");
        if (slideInfoNext) slideInfoNext.setAttribute("data-next", "");
    }
};
...
//         this.DOM = {
//             el: e
//         }, this.DOM.imgWrap = this.DOM.el.querySelector(".slide-img-wrap"), this.DOM.img = this.DOM.imgWrap.querySelector(".slide-img"), this.DOM.headline = this.DOM.el.querySelector(".slide-caption .head-line"), this.DOM.el.querySelector(".slide .wrap-view-more") && (this.DOM.Link = this.DOM.el.querySelector(".slide .wrap-view-more"), this.DOM.text = this.DOM.el.querySelectorAll(".box-text .inner-box")), this.DOM.el.querySelector(".box-text .inner-box") && (this.DOM.text = this.DOM.el.querySelectorAll(".box-text .inner-box"))
//     }, t = function () {
//         function e(e) {
//             this.DOM = {
//                 el: e
//             }, this.DOM.ctrls = {
//                 next: this.DOM.el.querySelector(".nav-next"), prev: this.DOM.el.querySelector(".nav-prev")
//             }, this.DOM.pagicurrent = this.DOM.el.parentNode.querySelector(".pagi-current"), this.DOM.space = this.DOM.el.parentNode.querySelector("small"), this.DOM.total = this.DOM.el.parentNode.querySelector(".pagi-total")
//         }
//
...
//             this.DOM = {
//                 el: t
//             }, this.DOM.slides = Array.from(this.DOM.el.querySelectorAll(".slide")), this.slides = [], this.DOM.slides.forEach((function (t) {
//                 return i.slides.push(new e(t))
//             })), this.slidesTotal = this.slides.length, this.current = 0, // 1 == this.slidesTotal &&
...
//             var e = this;
//             this.DOM.slides[this.current].classList.add("slide-current"), gsap.set(this.slides[this.current].DOM.imgWrap, {
//                 clipPath: this.config.clipPath.initial
//             }), firstItem.querySelector(".slide-img").classList.add("show"), setTimeout((function () {
//                 firstItem.querySelector(".slide-caption").classList.add("show")
//                 firstItem.querySelector(".wrap-view-more") && firstItem.querySelector(".wrap-view-more").classList.add("current"), e.slidesTotal > 1 && (startAutoplay(!0), e.DOM.el.parentNode.querySelector(".nav-slideshow").classList.add("show"), e.DOM.el.parentNode.querySelector(".nav-pagination").classList.add("show"))
//             }), 1e3)
//         }
//             , a.hover = function () {
//             var e = this, t = this.slides[this.current];
//             if (t.DOM.Link) var i = t.DOM.Link.querySelector(".icon-svg");
//             i && (i.addEventListener("mouseenter", (function () {
//                 stopAutoplay(), gsap.killTweensOf(t.DOM.imgWrap), gsap.killTweensOf(t.DOM.img), gsap.timeline().to(t.DOM.imgWrap, {
//                     duration: 1, clipPath: e.config.clipPath.hover, ease: "expo"
//                 }).to(t.DOM.img, {
//                     duration: .5, xPercent: 15, scale: .65, ease: "power2"
//                 })
//             })), i.addEventListener("mouseleave", (function () {
//                 gsap.killTweensOf(t.DOM.imgWrap), gsap.killTweensOf(t.DOM.img), gsap.timeline().to(t.DOM.img, {
//                     duration: .5, xPercent: 0, scale: 1, ease: "back"
//                 }).to(t.DOM.imgWrap, {
//                     duration: 1, clipPath: e.config.clipPath.initial, ease: "expo"
...
//             var r = this.slides[this.current], s = Math.floor(115 * Math.random() - 99);
//             gsap.to(".leaf", {
//                 duration: 1, rotation: s, ease: "none", stagger: .2
//             });
//             // var o = gsap.timeline({
//             //     onStart: function () {
...
//             //     }
//             // });
//             o.addLabel("start", 0), o.set(r.DOM.imgWrap, {
//                 yPercent: "next" === e ? 100 : -100, clipPath: this.config.clipPath.final
//             }, "start"), o.set(r.DOM.img, {
//                 yPercent: "next" === e ? -50 : 50
//             }, "start"), o.set(r.DOM.headline, {
//                 yPercent: "next" === e ? 450 : -450
//             }, "start"), r.DOM.Link && (o.set(r.DOM.text, {
//                 yPercent: 200
//             }, "start"), o.set(r.DOM.Link, {
//                 opacity: 0, yPercent: 150
//             }, "start")), r.DOM.text && o.set(r.DOM.text, {
//                 yPercent: 200
//             }, "start"), o.to(n.DOM.pagicurrent, {
//                 duration: .5, opacity: 0, yPercent: 100, ease: "none"
//             }, "start"), o.to(n.DOM.total, {
//                 duration: .5, opacity: 0, yPercent: -100, ease: "none"
//             }, "start"), o.to(n.DOM.space, {
//                 duration: .5, opacity: 0, ease: "none"
//             }, "start"), o.to(a.DOM.imgWrap, {
//                 duration: 1, clipPath: this.config.clipPath.final, ease: "power3"
//             }, "start"), o.to(a.DOM.img, {
//                 duration: 1, yPercent: "next" === e ? 50 : -50, ease: "power2.inOut"
//             }, "start+=0.6"), o.to(a.DOM.imgWrap, {
//                 duration: 1, yPercent: "next" === e ? -100 : 100, ease: "power2.inOut"
//             }, "start+=0.6"), o.to(a.DOM.headline, {
//                 duration: 1.2, yPercent: "next" === e ? -450 : 450, ease: "power3"
//             }, "start"), a.DOM.Link && (o.to(a.DOM.text, {
//                 duration: .5, opacity: 0, yPercent: "next" === e ? -200 : 200, ease: "power3"
//             }, "start"), o.to(a.DOM.Link, {
//                 duration: .5, opacity: 0, yPercent: "next" === e ? -150 : 150, ease: "power3"
//             }, "start")), a.DOM.text && o.to(a.DOM.text, {
//                 duration: .5, opacity: 0, yPercent: "next" === e ? -200 : 200, ease: "power3"
//             }, "start"), o.to(r.DOM.imgWrap, {
//                 duration: 1, yPercent: 0, ease: "power2.inOut"
//             }, "start+=0.6"), o.to(r.DOM.img, {
//                 duration: 1, yPercent: 0, ease: "power2.inOut"
//             }, "start+=0.6"), o.to(r.DOM.imgWrap, {
//                 duration: 1.5, clipPath: this.config.clipPath.initial, ease: "expo.inOut"
//             }, "start+=1.2"), o.to(r.DOM.headline, {
//                 duration: 1.2, yPercent: 0, ease: "power3"
//             }, "start"), r.DOM.Link && (o.to(r.DOM.text, {
//                 duration: 1, opacity: 1, yPercent: 0, ease: "power3"
//             }, "start+=2.4"), o.to(r.DOM.Link, {
//                 duration: 1, opacity: 1, yPercent: 0, ease: "power3"
//             }, "start+=2.6")), r.DOM.text && o.to(r.DOM.text, {
//                 duration: 1, opacity: 1, yPercent: 0, ease: "power3"
//             }, "start+=2.4")
//         }
//             , t
//     }())(document.querySelector(".slide-banner")), n = new t(document.querySelector(".nav-slideshow"));
//     i.slidesTotal > 1 && (n.DOM.ctrls.next.addEventListener("click", (function (e) {
//         return e.preventDefault(), e.stopPropagation(), i.next()
//     })), n.DOM.ctrls.prev.addEventListener("click", (function (e) {
//         return e.preventDefault(), e.stopPropagation(), i.prev()
//     })), n.updateCurrent(i.current), n.DOM.total.innerHTML = i.current < 10 ? "0".concat(i.slidesTotal) : i.slidesTotal, slideBanner.addEventListener("swiperight", (function (e) {
//         return e.preventDefault(), e.stopPropagation(), n.DOM.ctrls.next.click()
//     }), {
//         passive: !1
//     }), slideBanner.addEventListener("swipeleft", (function (e) {
//         return e.preventDefault(), e.stopPropagation(), n.DOM.ctrls.prev.click()
//     }), {
//         passive: !1
//     }))
// }
...
//
// function Search() {
//     var e = document.querySelector(".seach-top"), t = document.querySelector(".seach-top .search-but"),
//         r = document.querySelector(".seach-top .search-form"), o = document.querySelector(".seach-top .search-error");
//
//     function s() {
//         var e = document.getElementById("quick_search").value, t = document.getElementById("href_search").value;
//         if (e != document.getElementById("default_value").value && "" != e) if (e.length <= 2) {
//             o.querySelector(".search-error-content").innerHTML = a, o.classList.add("show");
//             var r = setTimeout(hidemsg, 3e3);
//             o.addEventListener("click", (function (e) {
//                 hidemsg(), clearTimeout(r)
//             }))
//         } else if ("" != e) {
...
//         a.preventDefault(), s(), t.classList.contains("active") && !o.classList.contains("show") ? (t.classList.remove("active"), r.classList.remove("active"), overlayClick.classList.remove("active")) : (t.classList.add("active"), r.classList.add("active"), overlayClick.classList.add("active")), t.classList.contains("active") && document.addEventListener("click", (function (o) {
//             var a = document.querySelector(".header"), n = o.target;
//             do {
//                 if (n == a) return;
//                 n = n.parentNode
//             } while (n);
//             t.classList.remove("active"), r.classList.remove("active"), e.querySelector(".holder").classList.remove("hide")
//         }))
//     })), document.getElementById("Search").addEventListener("keydown", (function (e) {
//         13 === e.keyCode && s()
//     }));
//     var i = document.querySelector(".advance-box"), l = document.querySelector(".advance-box .button"),
...
//             if (null === t) {
//                 u.querySelector(".search-error-content-category").innerHTML = c, u.classList.add("show");
//                 var r = setTimeout(hidemsg, 3e3);
//                 return !1
//             }
//             var o = t.dataset.name, s = document.getElementById("href_advance").value;
//             if (e == document.getElementById("default_advance").value || "" == e) d.querySelector(".search-error-content").innerHTML = n, d.classList.add("show"); else if (e.length <= 2) d.querySelector(".search-error-content").innerHTML = a, d.classList.add("show"); else if ("" != e) {
//                 if (void 0 !== o) var i = s + "?advancesearch=" + encodeURIComponent(e) + "&TermId=" + o; else i = s + "?advancesearch=" + encodeURIComponent(e);
//                 window.location = i
//             }
...
//         }
//
//         document.getElementById("Advance").reset(), l.addEventListener("click", (function (o) {
//             o.preventDefault(), t.classList.contains("active") && (document.getElementById("Advance").reset(), t.classList.remove("active"), r.classList.remove("active"), e.querySelector(".search-form .holder").classList.remove("hide")), m()
...
//     if (p) {
//         var y = 10, v = document.querySelectorAll(".item-search");
//         v.length > y && (v.forEach((function (e, t) {
//             e.classList.toggle("hide", t >= 10)
//         })), p.classList.add("show")), p.querySelector(".view-more").addEventListener("click", (function (e) {
//             for (var t = y; t < y + 6; t++) v[t] && v[t].classList.remove("hide");
//             (y += 6) >= v.length && (event.target.style.display = "none", p.remove())
//         }))
//     }
// }
