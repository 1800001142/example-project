var UA = navigator.userAgent || navigator.userAgentData || navigator.appVersion || navigator.platform
    ...
    , isMobile = Touch && Mobile.matches
    , isTablet = Touch && Tablet.matches
    , iOS = !1;
function checkiOS() {
...
function isFullScreenMode() {
    ...
    return 1 == e && document.documentElement.classList.add("fullsreen-support"),
        e
}
...
function pinchZoom(t, e, n) {
    ...
    var i = (e = void 0 !== e && Object.keys(e).length ? e : {}).scaleDefault || 2
        ...
        if (["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"].indexOf(navigator.platform) > -1 || navigator.userAgent.includes("Mac") && "ontouchend"in document) {
            ...
            if (t.indexOf("safari") > -1 && -1 === t.indexOf("chrome"))
                return !0
        }
        return !1
    }();
    ...
    if (window.addEventListener("load", (function() {
            ...
            window.addEventListener("resize", (function() {
                    for (var t = 0; t < Q.length; t++)
                        f = Q[t],
                            m = f.children[0],
                        !1 !== st(f, j) && (g = f.clientHeight,
                            p = f.clientWidth,
                            A = m.clientHeight,
                            E = m.clientWidth,
                            M = parseFloat(m.getAttribute(G)),
                            x = parseFloat(m.getAttribute(Z)),
                            C = pt(E, p, q = i),
                            H = pt(A, g, q),
                            U = E * q > p ? dt(M, -1 * C, C) : 0,
                            D = A * q > g ? dt(x, -1 * H, H) : 0,
                        1 === q && (wt(f),
                            wt(_)),
                            m.setAttribute(V, q),
                            m.setAttribute(G, U),
        ...
        lt(Q, "mousedown", (function(t) {
                ...
                else if (et[0] === t.target && nt <= 5 && !0 === ct(y, et[1] - 10, et[1] + 10) && !0 === ct(T, et[2] - 10, et[2] + 10))
                    return at(m, $),
                        !0 === st(f, j) ? (m.setAttribute(V, 1),
                            m.setAttribute(G, 0),
                            m.setAttribute(Z, 0),
                            wt(f),
                            wt(_),
                            ht(m, 0, 0, 1)) : (O = t.clientX,
                            I = t.clientY,
                            R = (i - 1) * (k = 1),
                            C = pt(E, p, q = i),
                            H = pt(A, g, q),
                            q <= 1 ? (U = 0,
                                D = 0) : (U = E * q <= p ? 0 : dt(M - (O - v - p / 2 - M) / (q - R) * R, -1 * C, C),
                                D = A * q <= g ? 0 : dt(x - (I - w - g / 2 - x) / (q - R) * R, -1 * H, H)),
                            vt(f),
                            vt(_),
                            m.setAttribute(V, q),
                            m.setAttribute(G, U),
                ...
                P = f.getBoundingClientRect(),
                    ...
                    M = parseFloat(m.getAttribute(G)),
                    x = parseFloat(m.getAttribute(Z)),
                    b = dt(parseFloat(m.getAttribute(V)), u, o),
                    nt = 0,
                    tt = !0
            }
        )),
        document.addEventListener("mousemove", (function(t) {
                ...
                O = t.clientX,
                    ...
                    C = pt(E, p, q = b),
                    H = pt(A, g, q),
                    U = E * q <= p ? 0 : dt(O - (y - M), -1 * C, C),
                    D = A * q <= g ? 0 : dt(I - (T - x), -1 * H, H),
                    nt++,
                Math.abs(U) === Math.abs(C) && (M = U,
                    y = O);
                Math.abs(D) === Math.abs(H) && (x = D,
                    T = I);
                m.setAttribute(V, q),
                    m.setAttribute(G, U),
                    m.setAttribute(Z, D),
        ...
        lt(Q, "touchstart", (function(t) {
                ...
                1 === (B = t.touches.length)) {
                    ...
                    else if (ot[0] === t.target && rt <= 1 && !0 === ct(y, ot[1] - 10, ot[1] + 10) && !0 === ct(T, ot[2] - 10, ot[2] + 10))
                        return at(m, $),
                            !0 === st(f, j) ? (m.setAttribute(V, 1),
                                m.setAttribute(G, 0),
                                m.setAttribute(Z, 0),
                                wt(f),
                                wt(_),
                                ht(m, 0, 0, 1)) : (O = t.touches[0].clientX,
                    ...
                    2 === B && (M = parseFloat(m.getAttribute(G)),
                        x = parseFloat(m.getAttribute(Z)),
                        S = t.touches[1].clientX,
                        F = t.touches[1].clientY,
                        N = (y + S) / 2,
                        Y = (T + F) / 2,
                        L = Math.sqrt((y - S) * (y - S) + (T - F) * (T - F)));
                rt = 0,
                    tt = !0
            }
        )),
        document.addEventListener("touchmove", (function(t) {
                ...
                O = t.touches[0].clientX,
                    ...
                    B = t.touches.length,
                    rt++,
                    B > 1 ? (X = t.touches[1].clientX,
                        W = t.touches[1].clientY,
                        z = Math.sqrt((O - X) * (O - X) + (I - W) * (I - W)),
                    null === L && (L = z),
                    Math.abs(L - z) >= 1 && (q = dt(z / L * b, u, o),
                        C = pt(E, p, q),
                        H = pt(A, g, q),
                        R = q - b,
                        U = E * q <= p ? 0 : dt(M - (N - v - p / 2 - M) / (q - R) * R, -1 * C, C),
                        D = A * q <= g ? 0 : dt(x - (Y - w - g / 2 - x) / (q - R) * R, -1 * H, H),
                        q > 1 ? (vt(f),
                            vt(_)) : (wt(f),
                            wt(_)),
                        ht(m, U + "px", D + "px", q),
        ...
        document.addEventListener("touchend", (function(t) {
                if (B = t.touches.length,
                !1 === tt)
                    return !1;
                0 === B ? (m.setAttribute(V, b),
                    m.setAttribute(G, U),
                    m.setAttribute(Z, D),
                    L = null,
                    tt = !1) : 1 === B ? (y = t.touches[0].clientX,
                    T = t.touches[0].clientY) : B > 1 && (L = null)
            }
        )),
    1 == a)
        return !1;
    lt(Q, "mouseenter", (function() {
            window.addEventListener("DOMMouseScroll", ft, !1),
                window.addEventListener("wheel", ft, h),
                window.addEventListener("touchmove", ft, h),
                window.addEventListener("keydown", mt, !1)
        }
    )),
        lt(Q, "mouseleave", (function() {
                window.removeEventListener("DOMMouseScroll", ft, !1),
                    window.removeEventListener("wheel", ft, h),
                    window.removeEventListener("touchmove", ft, h),
                    window.removeEventListener("keydown", mt, !1)
            }
        )),
        lt(Q, "wheel", (function(t) {
                if (f = this,
                    at(m = this.children[0], $),
                    setTimeout((function() {
                            gt(m, $)
                        }
                    ), c),
    ...
    function lt(t, e, n, i) {
        ...
        for (var r = 0; r < t.length; r++)
            t[r].addEventListener(e, n, i)
    }
    function dt(t, e, n) {
        return t < e ? t = e : t > n && (t = n),
            t
    }
    function ht(t, e, n, i) {
...
isFullScreenMode(),
    function(t, e) {
        ...
        "function" != typeof t.CustomEvent && (t.CustomEvent = function(t, n) {
            ...
            e.addEventListener("mousedown", s, !1),
        ...
        function c(t) {
            if (a === t.target) {
                var e = parseInt(a.getAttribute("data-swipe-threshold") || "20", 10)
                    , c = parseInt(a.getAttribute("data-swipe-timeout") || "500", 10)
                    , s = Date.now() - u
                    , l = "";
                Math.abs(r) > Math.abs(o) ? Math.abs(r) > e && s < c && (l = r > 0 ? "swipeleft" : "swiperight") : Math.abs(o) > e && s < c && (l = o > 0 ? "swipeup" : "swipedown"),
                "" !== l && a.dispatchEvent(new CustomEvent(l,{
                    bubbles: !0,
                    cancelable: !0
                })),
                    n = null,
        ...
        function s(t) {
            "swipe-ignore" !== t.target.dataset && (a = t.target,
                u = Date.now(),
                n = t.touches ? t.touches[0].clientX : t.clientX,
        ...
        function l(t) {
            if (n && i) {
                var e = t.touches ? t.touches[0].clientX : t.clientX
                    , u = t.touches ? t.touches[0].clientY : t.clientY;
                r = n - e,
                    o = i - u
            }
        }
...
const Splitting = function() {
    ...
    function r(e, n, r, o) {
        ...
        return n && (u.className = n),
        r && (!o && u.setAttribute("data-" + n, r),
            u.textContent = r),
        e && i(e, u) || u
    }
    function o(t, e) {
        ...
        return u(t.childNodes).some((function(t) {
                if (!t.tagName || t.hasChildNodes()) {
                    if (t.childNodes && t.childNodes.length)
                        return h.push(t),
                            void l.push.apply(l, g(t, n, o, a, s));
                    var i = t.wholeText || ""
                        , u = i.trim();
                    u.length && (" " === i[0] && h.push(e(" ")),
                        c(u.split(o), (function(t, e) {
    ...
    var p = "words"
        , v = h(p, 0, "word", (function(t) {
            return g(t, "word", /\s+/, 0, 1)
        }
    ))
        , w = "chars"
        , b = h(w, [p], "char", (function(t, e, n) {
            var i = [];
    ...
    function E(t, e, n) {
        var i = u(e.matching || t.children, t)
            , r = {};
...
function getAverageRGB(t) {
    ...
    if (!a)
        return o;
    i = u.height = t.naturalHeight || t.offsetHeight || t.height,
        n = u.width = t.naturalWidth || t.offsetWidth || t.width,
        a.drawImage(t, 0, 0);
    try {
...
function convertText(t, e) {
    return t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.toLowerCase()).replace(/à|á|ạ|ả|ã|â|ầ|ấ|ậ|ẩ|ẫ|ă|ằ|ắ|ặ|ẳ|ẵ/g, "a")).replace(/è|é|ẹ|ẻ|ẽ|ê|ề|ế|ệ|ể|ễ/g, "e")).replace(/ì|í|ị|ỉ|ĩ/g, "i")).replace(/ò|ó|ọ|ỏ|õ|ô|ồ|ố|ộ|ổ|ỗ|ơ|ờ|ớ|ợ|ở|ỡ/g, "o")).replace(/ù|ú|ụ|ủ|ũ|ư|ừ|ứ|ự|ử|ữ/g, "u")).replace(/ỳ|ý|ỵ|ỷ|ỹ/g, "y")).replace(/đ/g, "d")).replace(/\u0300|\u0301|\u0303|\u0309|\u0323/g, "")).replace(/\u02C6|\u0306|\u031B/g, ""),
        e ? t.toUpperCase() : t
}
!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).smoothScrolling = e()
        ...
        var n = function() {
            function e(e) {
                ...
                this.duration = e.duration,
                    ...
                    this.DOM.transY = this.DOM.el.classList.contains("transform-y") || this.DOM.el.classList.contains("bg-cover") || this.DOM.el.classList.contains("product-item") || this.DOM.el.classList.contains("slide-banner") || this.DOM.el.classList.contains("effect-leaf") || this.DOM.el.classList.contains("column-line"),
                    this.DOM.transX = this.DOM.el.classList.contains("transform-x") || this.DOM.el.classList.contains("trans-x"),
                    this.DOM.scaleY = this.DOM.el.classList.contains("scale-stran"),
                    this.DOM.rotageY = this.DOM.el.classList.contains("rotage-stran"),
                    this.DOM.scaleXY = this.DOM.el.classList.contains("scale-stran-left"),
                    this.speed = this.DOM.el.dataset.speed,
                    this.docScroll,
                    this.endScroll,
                    this.scrollingSpeed,
                    this.getPageYScroll = function() {
                    ...
                    ,
                    "horizontal" === this.orientation ? this.getPageXScroll() : this.getPageYScroll(),
                    this.renderedStyles = {
                        tranform: {
                            previous: 0,
                            current: 0,
                            ...
                            setValue: function() {
                                if ("horizontal" === i.orientation)
                                    var e = -1 * (n = parseInt(innerWidth / 10))
                                        , s = innerWidth < i.props.width ? i.props.width : innerWidth
                                        , o = t.map(i.props.left - i.docScroll, s, -1 * i.props.width, n, e);
                                else {
                    ...
                    this.Observer = new IntersectionObserver((function(t) {
                            t.forEach((function(t) {
                                    if (t.isIntersecting)
                                        return t.target.classList.add("is-show"),
                                            i.isVisible = t.intersectionRatio > 0;
            ...
            return i.Reset = function() {
                ...
                ,
                i.upDate = function() {
                    for (var t in this.scrollingSpeed = Math.abs(this.docScroll - this.endScroll),
                        this.endScroll = this.docScroll,
                        this.renderedStyles)
                        this.renderedStyles[t].current = this.renderedStyles[t].previous = this.renderedStyles[t].setValue();
                    this.getSize()
                }
                ,
                i.Render = function() {
                    for (var e in this.renderedStyles)
                        this.renderedStyles[e].current = this.renderedStyles[e].setValue(),
                            this.renderedStyles[e].previous = t.lerp(this.renderedStyles[e].previous, this.renderedStyles[e].current, this.renderedStyles[e].ease);
                    this.upDate(),
                        this.Translate()
                }
                ,
                i.Translate = function() {
                    var t = this.speed / 1.5 * this.renderedStyles.tranform.previous
                        , e = Math.round("".concat(t))
                        , i = Math.round("".concat(t / 1.2))
                        , s = 1 - "".concat(t) / (innerHeight / 2)
                        , o = t / 4;
                    this.DOM.transY && (this.DOM.el.style.transform = "translate3d(0," + e + "px,0)"),
                    this.DOM.transX && (this.DOM.el.style.transform = "translate3d(" + i + "px,0,0)"),
                    this.DOM.scaleY && (this.DOM.el.style.transform = "translate3d(0," + e + "px,0) scale3d(" + s + "," + s + ",1)"),
                    this.DOM.scaleXY && (this.DOM.el.style.transform = "translate3d(" + i + "px," + e + "px,0) scale3d(" + s + "," + s + ",1)"),
                    this.DOM.rotageY && (this.DOM.el.style.transform = "translate3d(" + i + "px," + e + "px,0) rotate(" + o + "deg)")
                }
                ,
                i.Resize = function() {
                    this.upDate(),
                ...
                i.destroy = function(t) {
                    ...
                    Array.from(t, (function(t) {
                        ...
                        this.DOM.el.classList.remove("is-show"),
            ...
            return i.advance = function(e) {
                ...
                if (this.isRunning) {
                    var s = !1;
                    if (this.lerp)
                        this.value = t.damp(this.value, this.to, 60 * this.lerp, e),
                        Math.round(this.value) === this.to && (this.value = this.to,
                            s = !0);
                    else {
                        this.currentTime += e;
                        var o = t.clamp(0, this.currentTime / this.duration, 1)
                            , n = (s = o >= 1) ? 1 : this.easing(o);
                        this.value = this.from + (this.to - this.from) * n
                    }
                    null == (i = this.onUpdate) || i.call(this, this.value, s),
                    s && this.stop()
                }
            }
                ,
                ...
                i.fromTo = function(t, e, i) {
                    var s = void 0 === i.lerp ? .1 : i.lerp
                        , o = void 0 === i.duration ? 1 : i.duration
            ...
            , l = function() {
            function t(t) {
                var e, i, s, o = this, n = void 0 === t ? {} : t, r = void 0 === n.wrapper || n.wrapper, l = void 0 === n.content || n.content, h = void 0 === n.main ? null : n.main, a = void 0 !== n.mainsize && n.mainsize, c = void 0 === n.orientation ? "vertical" : n.orientation, u = void 0 === n.autoResize || n.autoResize;
                if (this.wrapper = r,
                    this.content = l,
                    this.main = h,
                    this.mainsize = a,
                    ...
                    this.setSize = function() {
                        var t = 0
                            , e = 0
                            , i = 0;
                        if (o.main.removeAttribute("style"),
                        "horizontal" === o.orientation) {
                            for (var s = o.main.children, n = 0; n < s.length; n++) {
                                for (var r = s[n].children, l = 0; l < r.length; l++)
                                    i += r[l].offsetWidth;
                                e = i
                            }
                            o.main.style.width = e + "px"
                        } else
                            t = o.main.offsetHeight,
                                o.main.style.height = t + "px"
                    }
                    ,
                    ...
                    this.resize = function() {
                        o.onWrapperResize(),
                            o.onContentResize(),
                        null != o.main && o.mainsize && o.setSize()
                    }
                    ,
                    u) {
                    var d = (e = this.resize,
                    ...
                    this.wrapper !== window && (this.wrapperResizeObserver = new ResizeObserver(d),
                        this.wrapperResizeObserver.observe(this.wrapper)),
                        this.contentResizeObserver = new ResizeObserver(d),
            ...
            return t.prototype.destroy = function() {
                ...
                null != this.main && this.mainsize && (this.main.removeAttribute("style"),
                    this.setSize = null)
            }
                ,
                o(t, [{
            ...
            return e.emit = function(t) {
                for (var e = this.events[t] || [], i = arguments.length, s = new Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++)
                    s[o - 1] = arguments[o];
            ...
            function e(e, i) {
                var s = this
                    , o = !1;
                this.element = e,
                    this.smoothTouch = i.smoothTouch,
                    this.smoothMouse = i.smoothMouse,
                    this.wheelMultiplier = i.wheelMultiplier,
                    this.touchMultiplier = i.touchMultiplier,
                    this.mouseMultiplier = i.mouseMultiplier,
                    this.normalizeWheel = i.normalizeWheel,
                    ...
                    this.onMouseMove = function(t) {
                        if (s.smoothMouse && !Touch) {
                            ...
                            var o = (e + s.x) * s.mouseMultiplier
                                , n = -(i - s.y) * s.mouseMultiplier;
                            s.x = -e,
                                s.y = i,
                                s.lastDelta = {
                                    x: o,
                    ...
                    this.onWheel = function(e) {
                        var i = e.deltaX
                            , o = e.deltaY;
                        s.normalizeWheel && (i = t.clamp(-100, i, 100),
                            o = t.clamp(-100, o, 100)),
                            i *= s.wheelMultiplier,
                            o *= s.wheelMultiplier,
                            s.emitter.emit("scroll", {
        ...
        return function() {
            function s(t) {
                var e = this
                    , s = void 0 === t ? {} : t
                    , o = void 0 === s.wrapper ? window : s.wrapper
                    ...
                    , v = void 0 === s.eventsTarget ? m : s.eventsTarget
                    , f = void 0 === s.smoothWheel || s.smoothWheel
                    , g = void 0 !== s.smoothTouch && s.smoothTouch
                    , S = void 0 !== s.smoothMouse && s.smoothMouse
                    , y = void 0 !== s.syncTouch && s.syncTouch
                    , M = void 0 === s.syncTouchLerp ? .075 : s.syncTouchLerp
                    , b = void 0 === s.touchInertiaMultiplier ? 35 : s.touchInertiaMultiplier
                    , w = s.duration
                    , T = void 0 === s.easing ? function(t) {
                        return Math.min(1, 1.001 - Math.pow(2, -10 * t))
                    }
                    : s.easing
                    , z = void 0 === s.lerp ? !w && .1 : s.lerp
                    , O = void 0 !== s.infinite && s.infinite
                ...
                this.onVirtualScroll = function(t) {
                    var s = t.deltaX
                        ...
                        , n = t.event;
                    if (!n.ctrlKey) {
                        var r = n.type.includes("touch")
                            , l = n.type.includes("wheel")
                            , h = n.type.includes("mouse");
                        if ((e.options.smoothTouch || e.options.syncTouch) && r && "touchstart" === n.type)
                            e.reset();
                        else {
                            var a = 0 === s && 0 === o
                            ...
                            if (!a && !c) {
                                ...
                                if (!(u = u.slice(0, u.indexOf(e.rootElement))).find((function(t) {
                                    ...
                                    if (e.isStopped || e.isLocked)
                                        ...
                                        if (e.isSmooth = (e.options.smoothTouch || e.options.syncTouch) && r || e.options.smoothWheel && l || e.options.smoothMouse && h,
                                            !e.isSmooth)
                                        ...
                                        var p = r && e.options.syncTouch
                                            , m = r && "touchend" === n.type && Math.abs(d) > 5;
                                        m && (d = e.velocity * e.options.touchInertiaMultiplier),
                                            e.scrollTo(e.targetScroll + d, i({
                                                programmatic: !1
                                            }, p ? {
                ...
                o !== document.documentElement && o !== document.body || (o = window),
                    ...
                    this.isLocked = !1,
                    this.isStopped = !1,
                    this.isSmooth = y || f || g || S,
                    this.isScrolling = !1,
                    this.targetScroll = this.animatedScroll = this.actualScroll,
                    this.rootElement.setAttribute("data-orientation", this.options.orientation),
                    this.Items = [],
            ...
            return c.createBar = function() {
                if (this.isHorizontal) {
                    for (var t = 0, e = this.options.main.children, i = 0; i < e.length; i++)
                        t += e[i].offsetWidth;
                ...
                this.instanceY = this.options.content.offsetHeight - window.innerHeight,
                    ...
                    this.scrollbar.classList.add(this.options.scrollbarClass),
                    this.scrollThumb.classList.add("".concat(this.options.scrollbarClass, "-thumb")),
                    this.scrollbar.append(this.scrollThumb),
                    this.options.content == document.body ? this.options.content.append(this.scrollbar) : this.rootElement.append(this.scrollbar),
                    this.getBar()
            }
                ,
                c.getBar = function() {
                    if (this.scrollBCR = this.scrollbar.getBoundingClientRect(),
                        this.scrollbarHeight = this.scrollBCR.height,
                        this.scrollbarWidth = this.scrollBCR.width,
                        this.isHorizontal) {
                ...
                ,
                c.postBar = function() {
                    if (this.thumbHeight = this.scrollThumb.getBoundingClientRect().height,
                ...
                c.grabBar = function() {
                    ...
                    this.scrollThumb.addEventListener("pointerdown", (function(t) {
                        ...
                        window.addEventListener("pointermove", (function(o) {
                                s && (o.preventDefault(),
                                    t = i.isHorizontal ? e(s, innerWidth - (i.scrollThumb.offsetLeft - s), o.clientX, 0, i.limit) : e(s, innerHeight - (i.scrollThumb.offsetHeight - s), o.clientY, 0, i.limit),
                                    i.scrollTo(t, {
                                        immediate: !0
                                    }))
                            }
                ...
                c.Mover = function() {
                    for (var t = 0; t < this.Items.length; t++) {
                        var e = this.Items[t];
                        e.isVisible ? e.insideViewport ? e.Render() : (e.insideViewport = !0,
                            e.upDate()) : e.insideViewport = !1,
                            e.Render()
                    }
                }
                ,
                c.getObject = function() {
                    for (var t = "." + this.options.objectTrans, e = this.options.content.querySelectorAll(t), i = 0; i < e.length; i++)
                        this.aniobject = new n({
                            El: e[i],
                ...
                ,
                c.resize = function() {
                    null != this.options.scrollbarClass && (this.getBar(),
                        this.postBar()),
                    null != this.options.objectTrans && this.aniobject && this.aniobject.Resize(),
                ...
                c.scrollTo = function(e, i) {
                    var s = this
                        , o = void 0 === i ? {} : i
                        , n = void 0 === o.offset ? 0 : o.offset
                        , r = void 0 !== o.immediate && o.immediate
                        , l = void 0 !== o.lock && o.lock
                        ...
                        , u = void 0 === o.onComplete ? null : o.onComplete
                        , d = void 0 !== o.force && o.force
                    ...
                    if (!this.isStopped && !this.isLocked || d) {
                        if (["top", "left", "start"].includes(e))
                            ...
                            var m, v;
                            if ("string" == typeof e ? v = document.querySelector(e) : null != (m = e) && m.nodeType && (v = e),
                                v) {
                        ...
                        if ("number" == typeof e) {
                            if (e += n,
                                e = Math.round(e),
                                this.options.infinite ? p && (this.targetScroll = this.animatedScroll = this.scroll) : e = t.clamp(0, e, this.limit),
                                r)
                ...
                o(s, [{
                    ...
                    key: "className",
                    get: function() {
                        return this.isStopped && (this.options.scrollClass += " stopped"),
                        this.isLocked && (this.options.scrollClass += " locked"),
                        this.isScrolling && (this.options.scrollClass += " scrolling"),
                        this.isSmooth && this.options.scrollClass,
...
var timer, thatScroll, thatInner, thatSmall, Load = 0, Details = 0, First = 0, News = 0, XWidth = window.innerWidth, YHeight = window.innerHeight, windscroll = window.pageYOffset, Body = document.body, Container = document.querySelector(".container"), titlePage = document.querySelector(".title-page"), IDPage = Container.getAttribute("id"), Mask = document.querySelector(".mask"), overlayPath = document.querySelector(".overlay-path"), Header = document.querySelector(".header"), Logo = document.querySelector(".logo"), rightHeader = document.querySelector(".right-header"), Language = document.querySelector(".language"), searchBut = document.querySelector(".search-but"), formRowSearch = document.querySelector(".form-row-search"), Navigation = document.querySelector(".navigation"), Nav = document.querySelector(".nav"), mainMenu = document.querySelector(".main-menu"), navLi = document.querySelectorAll(".main-menu li"), hasSub = document.querySelectorAll(".has-sub"), naItems = document.querySelectorAll(".nav-item"), subItems = document.querySelectorAll(".sub-menu-drop"), overlayMenu = document.querySelector(".overlay-menu"), logoMenu = document.querySelector(".logo-menu"), navClick = document.querySelector(".nav-click"), Gohome = document.querySelector(".link-home"), Gopage = document.querySelectorAll(".link-load, .link-home, .go-detail, .order, .goback"), Gopop = document.querySelectorAll(".link-popup, .link-policy"), Footer = document.querySelector("footer"), Bottom = document.querySelector(".bottom"), allStories = document.querySelector(".all-stories"), wrapStories = document.querySelector(".wrap-all-stories"), overlayClick = document.querySelector(".overlay-click"), columnRotate = document.querySelector(".column-rotate"), secondMenu = document.querySelector(".second-menu"), outerNavSec = document.querySelector(".section-outernav"), outerNav = document.querySelector(".outer-nav"), clickHead = document.querySelectorAll(".sub-level"), wrapView = document.querySelectorAll(".wrap-view-more, .box-news, .search-view-more"), selectList = document.querySelector(".select-list"), selectHeader = document.querySelector(".select-header"), selectBox = document.querySelector(".select-box"), breadCrumb = document.querySelector(".breadcrumb"), bannerHome = document.querySelector(".banner-home"), slideBanner = document.querySelector(".slide-banner"), bannerInner = document.querySelector(".banner-inner"), bgMulti = document.querySelector(".bg-multi"), sticky = document.querySelectorAll(".sticky, .details-pics"), sticky_js = document.getElementById("sticky_js"), horScroll = document.querySelector(".hori-scroll"), Brands = document.querySelector(".brands"), Subscrible = document.querySelector(".subscribe"), contactForm = document.querySelector(".contact-form"), commentForm = document.querySelector(".comment-form"), searchForm = document.querySelector(".search-form"), forgetForm = document.querySelector(".forget-form"), loginForm = document.querySelector(".login-form"), registForm = document.querySelector(".register-form"), goBack = document.querySelector(".goback"), boxVideo = document.querySelector(".box-video-center .inline-video"), ytVideo = document.getElementById("youtube-video"), id_Inline = document.getElementById("video_js"), id_Youtube = document.getElementById("yt_js"), proBox = document.querySelectorAll(".product-box"), shareBox = document.querySelector(".share-box"), svgClose = '<svg viewBox="0 0 100 100"><circle class="c-rotate" cx="50" cy="50" r="48.5"></circle></svg>', A = document.createElement("div"), B = document.createElement("div"), C = document.createElement("div"), D = document.createElement("div"), E = document.createElement("div");
A.className = "all-pics",
    B.className = "all-album",
    C.className = "all-video",
    D.className = "overlay-dark",
    E.className = "loadx",
    Body.append(A, B, C, D, E);
var allPics = document.querySelector(".all-pics")
    , allAlbum = document.querySelector(".all-album")
    , allVideo = document.querySelector(".all-video")
...
if ("home-page" == IDPage) {
    ...
    (M = document.createElement("div")).className = "mask-inner",
        M.innerHTML = divMask,
        Mask.append(M)
} else
...
divX.className = "scroll-down",
    divY.className = "go-top",
    divX.innerHTML = X,
    divY.innerHTML = Y,
    Body.append(divX, divY);
var goTop = document.querySelector(".go-top")
    , scrollDown = document.querySelector(".scroll-down");
if (sticky.length > 0) {
    if (!sticky_js)
        (script = document.createElement("script")).id = "sticky_js",
            script.type = "text/javascript",
            script.src = getDirect + "Content/theme_btq/js/gsap/ScrollTrigger.js",
            document.body.appendChild(script);
    document.querySelector(".sticky-item") && (document.querySelector(".sticky-item:last-child").classList.add("last-child"),
        document.querySelector(".sticky-item:last-child").classList.add("last-child")),
    document.querySelector(".sticky-story") && (document.querySelector(".sticky-story:first-child").classList.add("first-child"),
        document.querySelector(".sticky-story:last-child").classList.add("last-child"))
}
boxVideo && (id_Inline || ((script = document.createElement("script")).id = "video_js",
    script.type = "text/javascript",
    script.src = getDirect + "Content/theme_btq/js/modules/video.js",
    (style = document.createElement("link")).id = "video_css",
    style.type = "text/css",
    style.rel = "stylesheet",
    style.href = getDirect + "Content/theme_btq/css/video.css",
    document.body.appendChild(script),
    document.body.appendChild(style),
    boxVideo.parentNode.parentNode.parentNode.setAttribute("data-video", "inline")));
ytVideo && (id_Youtube || ((script = document.createElement("script")).id = "yt_js",
    script.type = "text/javascript",
    script.src = getDirect + "Content/theme_btq/js/modules/youtube.js",
    (style = document.createElement("link")).id = "video_css",
    style.type = "text/css",
    style.rel = "stylesheet",
    style.href = getDirect + "Content/theme_btq/css/video.css",
    document.body.appendChild(script),
    document.body.appendChild(style),
    ytVideo.parentNode.parentNode.parentNode.setAttribute("data-video", "youtube")));
if (slideBanner) {
    var slide_js = document.getElementById("slide_js");
    if (!slide_js)
        (script = document.createElement("script")).id = "slide_js",
            script.type = "text/javascript",
            script.src = getDirect + "Content/theme_btq/js/modules/slide-banner.js",
            document.body.appendChild(script)
}
if ("details-page" == Container.dataset.details) {
    var format_js = document.getElementById("format_js");
    if (!format_js)
        (script = document.createElement("script")).id = "format_js",
            script.type = "text/javascript",
            script.src = getDirect + "Content/theme_btq/js/modules/format.js",
            document.body.appendChild(script)
}
if ("product-page" == IDPage || "supplier-page" == IDPage) {
    var style, proslide_js = document.getElementById("proslide_js");
    if (!proslide_js)
        (script = document.createElement("script")).id = "proslide_js",
            script.type = "text/javascript",
            script.src = getDirect + "Content/theme_btq/js/modules/slide.js",
            (style = document.createElement("link")).id = "slide_css",
            style.type = "text/css",
            style.rel = "stylesheet",
            style.href = getDirect + "Content/theme_btq/css/slide.css",
            document.body.appendChild(script),
            document.body.appendChild(style);
    ...
    if ("product-details-page" != Container.dataset.details || "product-details-special" != Container.dataset.details) {
        document.querySelectorAll(".slide-pro, .slide-pro-two").forEach((function(e) {
                ...
                t.className = "switch-nav",
                    t.innerHTML = M,
                    e.prepend(t)
            }
        ));
        for (var List = document.querySelectorAll(".product-list, .product-list-two"), i = 0; i < List.length; i++) {
            var Title = List[i].querySelector(".title-main h2").textContent
                , Num = i + 1;
            List[i].setAttribute("data-name", "go-" + Num),
                (A = document.createElement("div")).className = "item-list",
                (B = document.createElement("button")).className = "button",
                B.setAttribute("aria-label", "button"),
                B.setAttribute("data-target", "go-" + Num),
                B.textContent = Title,
                A.append(B),
                Header.append(A)
        }
        function addList() {
            ...
            for (var t = document.querySelectorAll(".item-list"), r = 0; r < t.length; r++)
                e.append(t[r]);
...
if ("product-details-page" == Container.dataset.details || "product-details-special" == Container.dataset.details) {
    ...
    if (!rating_js)
        (script = document.createElement("script")).id = "rating_js",
            script.type = "text/javascript",
            script.src = getDirect + "Content/theme_btq/js/modules/rating.js",
            document.body.appendChild(script);
    var script, qr_js = document.getElementById("qr_js");
    if (!qr_js)
        (script = document.createElement("script")).id = "qr_js",
            script.type = "text/javascript",
            script.defer = "defer",
            script.src = getDirect + "Content/theme_btq/js/modules/qrcode.js",
            document.body.appendChild(script);
    if (document.querySelector(".pro-text")) {
        ...
        if (textStyle)
            for (i = 0; i < textStyle.length; i++)
                textStyle[i].removeAttribute("style")
    }
    ...
    "product-page-07" == Container.dataset.second || "product-page-08" == Container.dataset.second || "product-page-09" == Container.dataset.second) {
        ...
        Release && (Release.querySelectorAll(".product-inner").forEach((function(e) {
                ...
                e.querySelector(".product-wrap").append(t),
                    e.querySelector(".product-pic .trans-x").classList.replace("trans-x", "trans-y"),
                    e.querySelector(".product-pic .transform-x").classList.replace("transform-x", "transform-y"),
                    e.classList.replace("product-inner", "product-inner-two")
            }
        )),
...
function addLeafs(e) {
    var t = ["l-01", "l-02", "l-03", "l-04", "l-05"]
    ...
    ["leaf-01", "leaf-02", "leaf-03", "leaf-04", "leaf-05", "leaf-06", "leaf-07"].forEach((function(e) {
        ...
        o.appendChild(a),
        o.className = "trans effect-leaf",
        o.setAttribute("data-speed", 3),
        o.classList.add(t[r]),
        e.append(o),
        e.classList.add(t[r]),
        gsap.timeline().fromTo(".leaf", 2, {
            opacity: 0,
            scale: 0,
            rotation: 0
        }, {
...
if (overlayMenu) {
    (Div = document.createElement("div")).className = "right-bg-menu",
...
if (bgMulti) {
    (Div = document.createElement("div")).className = "bg-multi-inner",
        bgMulti.appendChild(Div);
...
document.querySelector(".product-list-two") && Array.from(document.querySelectorAll(".product-list-two"), (function(e, t) {
    ...
    if (Array.from(document.querySelectorAll(".product-details"), (function(e, t) {
            var r = t + 1;
            if (e.querySelector(".details-wrap").setAttribute("data-color", "0" + r),
                e.querySelector(".details-wrap .product-title h2")) {
...
function cloneBread() {
    ...
    e.innerHTML = '<svg viewBox="0 0 50 50"><path fill="currentColor" d="M40.4,17L40.4,17L28.9,6.9c-2.2-2-5.5-2-7.7,0L9.8,17c-1.2,1.1-1.9,2.7-1.9,4.3v16.8c0,3.2,2.6,5.8,5.8,5.8h23c3.2,0,5.8-2.6,5.8-5.8V21.3C42.4,19.7,41.7,18.1,40.4,17z M28.9,40h-7.7v-9.6c0-1.1,0.9-1.9,1.9-1.9H27c1.1,0,1.9,0.9,1.9,1.9V40z M38.5,38.1c0,1.1-0.9,1.9-1.9,1.9h-3.8v-9.6c0-3.2-2.6-5.8-5.8-5.8h-3.8c-3.2,0-5.8,2.6-5.8,5.8V40h-3.8c-1.1,0-1.9-0.9-1.9-1.9V21.3c0-0.6,0.2-1.1,0.7-1.4L23.8,9.8c0.7-0.6,1.8-0.6,2.5,0l11.5,10.1c0.4,0.4,0.7,0.9,0.7,1.4V38.1z"></path></svg>',
        breadCrumb.querySelector(".link-home").append(e),
        breadCrumb.querySelector("li:last-child").classList.add("last");
    var t = breadCrumb.cloneNode(!0)
        , r = document.createElement("div");
    if (r.className = "bread-second",
        t.classList.replace("breadcrumb", "breadcrumb-second"),
        r.append(t),
        Header.append(r),
    Container.dataset.details && "news-page" == IDPage) {
        var o = document.querySelector(".load-title > .wrap-details > h2").textContent
            , a = document.createElement("li");
        a.innerHTML = '<div class="text-title"><span></span></div>',
            breadCrumb.querySelector(".breadcrumb ul").append(a);
...
if ("promotion-page" == IDPage) {
    var Div;
    (Div = document.createElement("div")).innerHTML = Tiles,
...
if (Array.from(document.querySelectorAll(".item-menu-second"), (function(e) {
        var t = document.createElement("span");
        t.className = "span-circle",
            t.innerHTML = '<svg viewBox="0 0 200 200"><circle class="before" fill="none" stroke="currentColor" cx="100" cy="100" r="90"/><circle class="center" fill="none" cx="100" cy="100" r="60"/><circle class="after" fill="none" stroke="currentColor" cx="100" cy="100" r="90"/></svg>',
            e.append(t)
    }
)),
    Logo) {
...
"register-page" != IDPage && "cart-page" != IDPage && "account-page" != IDPage && "list-order-page" != IDPage || (allStories.classList.replace("all-stories", "all-stories-second"),
...
function ResizeWindows() {
    ...
    if (Mobile.matches ? HTML.classList.add("is-mobile") : HTML.classList.remove("is-mobile"),
    ...
    bannerHome || bannerInner) {
        ...
        titlePage.style.setProperty("--top-height", t + "px"),
            scrollDown.style.setProperty("--top-height", t + "px"),
    ...
    if (document.querySelector(".trends .title-news p") && document.querySelectorAll(".trends .title-news p > span").forEach((function(e) {
        ...
        shareBox)
        if (Mobile.matches)
            document.querySelector(".detail-link").append(shareBox);
        else {
    ...
    if (document.querySelector(".option-product > div")) {
        var n = document.querySelector(".option-product")
            , c = document.querySelector(".detail-link")
            , s = document.querySelector(".pro-des");
        document.querySelector(".full-wrap").classList.add("nowrap"),
            document.querySelector(".product-details[data-intro]").classList.add("visible"),
            Tablet.matches ? (n.classList.add("wrap-ios"),
                document.querySelector(".full-wrap").append(n),
            document.querySelector(".product-info > .detail-link") && document.querySelector(".option-product").append(c)) : (n.classList.remove("wrap-ios"),
                document.querySelector(".details-info").append(n),
            document.querySelector(".option-product > .detail-link") && document.querySelector(".product-info").insertBefore(c, s)),
            document.querySelector(".details-pics").classList.add("wrap-right"),
            document.querySelector(".details-info").classList.add("wrap-left")
    }
}
if (document.querySelector(".login-click")) {
    var Alls = document.querySelectorAll(".login-click");
    for (i = 0; i < Alls.length; i++)
        2 == Alls.length && Alls[1].classList.replace("login-click", "login-click-2")
}
document.querySelectorAll("img").forEach((function(e) {
        ...
        if (t.src = e.src,
            t.onload = function() {
                ...
                e.setAttribute("width", this.width + "px"),
                    e.setAttribute("height", this.height + "px"),
                t <= 1 && e.parentNode.classList.add("ratio-h")
            }
            ,
        "" == e.getAttribute("alt")) {
            var r = e.src.replace(/^.*[\\\/]/, "");
...
function textBreak() {
    ...
    if (e)
        for (var t = 0; t < e.length; t++) {
            var r = document.createElement("div")
                , o = e[t].innerHTML;
            r.className = "text-inner",
                r.innerHTML = o,
                e[t].parentNode.appendChild(r),
                Splitting({
                    target: ".text-inner",
                    by: "chars",
                    key: null
    ...
    document.querySelector(".text-ani-wrap") && document.querySelectorAll(".text-ani-wrap").forEach((function(e) {
            if (e.querySelector("strong")) {
                ...
                t.innerHTML = r,
                    e.parentNode.append(t),
                    e.querySelector("strong").remove()
            }
            var o = document.createElement("h3")
                , a = e.textContent;
            o.className = "title-h3 color-white-shadow",
                o.innerHTML = a,
...
function onScroll() {
    var e = document.querySelectorAll(".ani-item,.title-main:not(.off-ani) .text-inner,.ani-text,.scroll-text,.item-pic,.content-sticky .off-ani, .absolute-inner")
        , t = new IntersectionObserver((function(e) {
            e.forEach((function(e) {
                    if (e.target.classList.contains("scroll-text") && (e.isIntersecting ? e.target.classList.add("fade") : e.target.classList.remove("fade")),
                        e.target.classList.contains("text-inner")) {
                        var t = e.target.querySelectorAll(".char");
                        e.isIntersecting && aniText(t)
                    }
                    e.target.classList.contains("off-ani") && e.isIntersecting && e.target.classList.add("fade"),
                    e.target.classList.contains("ani-text") && (e.isIntersecting ? e.target.querySelector("h3").classList.add("on-text") : e.target.querySelector("h3").classList.remove("on-text")),
                    e.target.classList.contains("item-pic") && e.intersectionRatio && e.target.classList.add("show"),
                    e.target.classList.contains("ani-item") && e.intersectionRatio && e.target.classList.add("on-show"),
                    e.target.classList.contains("absolute-inner") && e.isIntersecting && e.target.classList.add("show")
                }
            ))
        }
    ),{
    ...
    if (r && r.forEach((function(e) {
        ...
        var a = document.querySelectorAll(".item-pic > h3")
...
function viewItems(e) {
    var t = bannerHome ? window.innerHeight : document.querySelector(".sec-01").offsetHeight
        , r = document.querySelectorAll(".slide").length
        , o = document.querySelector(".bread-second");
    (e > 100 ? (Header.classList.add("hide"),
        loginBox.classList.add("top-short"),
        cartContent.classList.add("top-short"),
        scrollDown.classList.remove("show"),
        titlePage.classList.remove("show"),
    slideBanner && allStories.classList.remove("show")) : (Header.classList.remove("hide"),
        loginBox.classList.remove("top-short"),
        cartContent.classList.remove("top-short"),
        scrollDown.classList.add("show"),
        titlePage.classList.add("show"),
    slideBanner && allStories.classList.add("show")),
    "register-page" == IDPage || "cart-page" == IDPage || "account-page" == IDPage || "list-order-page" == IDPage) ? e > 200 ? goTop.classList.add("show") : goTop.classList.remove("show") : e > t / 2 ? (goTop.classList.add("show"),
        allStories.classList.replace("all-stories", "all-stories-second"),
        document.querySelector(".all-stories-second").classList.add("show")) : (goTop.classList.remove("show"),
        allStories.classList.replace("all-stories-second", "all-stories"));
    if (Container.dataset.details && "news-page" == IDPage && (e > t && e + t < document.body.offsetHeight - (window.innerHeight + t) ? document.querySelector(".sub-menu").classList.add("show") : document.querySelector(".sub-menu").classList.remove("show")),
    bannerHome && bannerHome.classList.contains("show") && r > 1 && (e >= t / 2 - 70 && (stopAutoplay(),
        startAutoplay(!1)),
    e <= 10 && startAutoplay(!0)),
    bannerInner && r > 1 && (e >= t / 2 - 70 && (stopAutoplay(),
        startAutoplay(!1)),
    e <= 10 && startAutoplay(!0)),
        e > t && "product-details-page" != Container.dataset.details ? o && o.classList.add("fixed") : o && o.classList.remove("fixed"),
    "product-details-page" == Container.dataset.details) {
    ...
    if ("product-page" == IDPage && document.querySelector(".sub-list")) {
        var n = document.querySelectorAll("section[data-name]")
            , c = document.querySelectorAll(".item-list");
        n.forEach((function(r) {
                var o = r.offsetTop - t
                    , a = r.offsetHeight;
                if (a < window.innerHeight && (a = window.innerHeight),
                e >= o && e <= o + a) {
                    RemoveClass(c);
...
function S_Trigger() {
    if (gsap.registerPlugin(ScrollTrigger),
        ...
        document.querySelector(".wrap-right:not(.slidefullwrap)")) {
    ...
    if (document.querySelector(".sticky-story")) {
        var t = document.querySelector(".pin-wrap")
            , r = document.querySelector(".sticky-story-pic")
            , o = r.querySelector(".absolute-inner")
            , a = r.querySelector(".circle-box");
        ScrollTrigger.matchMedia({
            "(pointer:fine) and (min-width:1100px)": function() {
                gsap.to(t, {
                    x: function() {
                ...
                e.to(o, {
                    ...
                    e.to(a, {
                        startAt: {
                            ...
                            backgroundImage: gsap.getProperty(a, "--color-white")
                        },
                ...
                gsap.utils.toArray(n).forEach((function(e, t) {
                        ...
                        ScrollTrigger.create({
                            ...
                            gsap.fromTo(".sticky-item.last-child", {
                                opacity: 1,
                                backgroundColor: gsap.getProperty(".sticky-item.last-child", "--color-bg")
                            }, {
...
var ScrollBody = function() {
    thatScroll = new smoothScrolling({
        ...
        requestAnimationFrame((function e(t) {
                sticky_js && gsap.ticker.lagSmoothing(0),
                    thatScroll.raf(t),
    ...
    thatInner = new smoothScrolling({
        ...
        window.addEventListener("keydown", (function(t) {
                ...
                38 == r && (t.preventDefault(),
                    e.scrollTop -= 50),
                40 == r && (t.preventDefault(),
                    e.scrollTop += 50)
            }
        ))
}
...
function CustomSelect() {
    for (var e = document.getElementsByClassName("custom-select"), t = 0; t < e.length; t++)
        if (!e[t].querySelector(".select-all-item")) {
            var r = e[t].getElementsByTagName("select")[0]
                , o = document.createElement("div")
                , a = document.createElement("div")
                , n = document.createElement("div")
                , c = document.createElement("div");
            o.className = "select-custom-head",
                o.innerHTML = r.options[r.selectedIndex].innerHTML,
                a.className = "select-all-item select-hide",
                n.className = "wrap-drop-down",
                c.className = "drop-select",
                e[t].append(o);
            for (var s = 1; s < r.length; s++) {
                var l = document.createElement("div");
                l.className = "select-item",
                    l.innerHTML = r.options[s].innerHTML;
                var i = r.options[s].getAttribute("value")
                    , d = r.options[s].getAttribute("data-href");
                i && l.setAttribute("data-value", i),
                d && l.setAttribute("data-href", d),
                    c.append(l),
                    n.append(c),
                    a.append(n),
                    l.addEventListener("click", (function(e) {
                            for (var t = this.parentNode.parentNode.parentNode.parentNode.getElementsByTagName("select")[0], r = this.parentNode.parentNode.parentNode.previousSibling, o = 0; o < t.length; o++)
                                if (t.options[o].innerHTML == this.innerHTML) {
                                    t.selectedIndex = o,
                                        r.innerHTML = this.innerHTML;
                                    for (var a = this.parentNode.parentNode.parentNode.getElementsByClassName("selected"), n = 0; n < a.length; n++)
            ...
            e[t].append(a),
                o.addEventListener("click", (function(e) {
                        if (e.stopPropagation(),
                            this.classList.contains("arrow-active")) {
                            this.nextSibling.classList.add("select-hide"),
                                this.classList.remove("arrow-active"),
                                this.parentNode.classList.remove("level-index-in");
                            for (var t = document.querySelectorAll(".select-custom-head"), r = 0; r < t.length; r++)
                                t[r].classList.contains("arrow-active") || thatScroll.start()
                        } else
                            thatScroll.stop(),
                                this.nextSibling.classList.remove("select-hide"),
                                this.classList.add("arrow-active"),
                                this.parentNode.classList.add("level-index-in")
                    }
                )),
    ...
    function u(e) {
        for (var t = [], r = document.getElementsByClassName("select-all-item"), o = document.getElementsByClassName("select-custom-head"), a = 0; a < o.length; a++)
            e == o[a] ? t.push(a) : (o[a].classList.remove("arrow-active"),
                o[a].parentNode.classList.remove("level-index-in"));
        for (a = 0; a < r.length; a++)
            t.indexOf(a) && r[a].classList.add("select-hide");
        thatScroll.start()
    }
}
if (selectList) {
    ...
    function resetList() {
        selectHeader.querySelector("h3").innerHTML = Text,
            selectHeader.classList.remove("onclick"),
            selectBox.querySelector("li").classList.remove("selected"),
            selectBox.scrollTop = 0
    }
    selectHeader.querySelector("h3").innerHTML = Text,
        selectBox.classList.add("hide"),
        selectHeader.addEventListener("click", (function(e) {
                this.classList.contains("onclick") ? (selectBox.classList.remove("hide"),
                    ...
                    document.addEventListener("click", (function(e) {
                            document.querySelector(".advance-box").contains(e.target) || (selectBox.classList.remove("hide"),
                                selectBox.classList.add("show"),
                                gsap.to(selectBox, {
                                    duration: .3,
                                    opacity: 0,
        ...
        selectBox.querySelectorAll("button").forEach((function(e) {
                e.addEventListener("click", (function(t) {
                        t.preventDefault(),
                            RemoveClass(selectBox.querySelectorAll("li")),
                            selectHeader.querySelector("h3").innerHTML = e.textContent,
...
if (Subscrible) {
    if ("vi" == HTML.lang)
        var textError = "Email không hợp lệ!";
    else
...
if (loginForm) {
    if ("vi" == HTML.lang)
        var textError_1 = "Nhập tên đăng nhập!"
            , textError_2 = "Nhập mật khẩu!";
    else
        textError_1 = "Enter Username!",
            textError_2 = "Enter Your password!";
    document.getElementById("loginName").dataset.error = textError_1,
        document.getElementById("loginPass").dataset.error = textError_2
}
if (contactForm) {
    if ("vi" == HTML.lang) {
...
if (commentForm) {
    if ("vi" == HTML.lang)
        textError_1 = "Nhập tên!",
            textError_2 = "Email không hợp lệ!";
    else
        textError_1 = "Enter a name!",
            textError_2 = "Invalid email!";
    document.getElementById("namecomment").dataset.error = textError_1,
        document.getElementById("emailcomment").dataset.error = textError_2
}
if ("vi" == HTML.lang)
    var cartMess = '<div class="cart-mess">Chưa có sản phẩm trong giỏ hàng</div>';
else
    cartMess = '<div class="cart-mess">No products in the cart</div>';
if ("register-page" == IDPage || "account-page" == IDPage || "cart-page" == IDPage) {
    if ("vi" == HTML.lang)
        var Mess = '<span class="note-pass">Mật khẩu phải bao gồm:</span><span class="letter invalid">Chữ cái <strong>viết thường</strong></span><span class="capital invalid">Chữ cái <strong>viết Hoa</strong></span><span class="number invalid"><strong>Các số đếm</strong></span><span class="length invalid">Ít nhất <strong>8 ký tự</strong></span>';
    else
        Mess = '<span class="note-pass">Password must include:</span><span class="letter invalid"><strong>Lowercase</strong> letter</span><span class="capital invalid"><strong>Capital (uppercase)</strong> letter</span><span class="number invalid"><strong>Number</strong></span><span class="length invalid">Minimum <strong>8 characters</strong></span>';
    if (document.querySelector(".mess-pass")) {
        var empty = document.createElement("div");
        empty.className = "mess-inner",
            empty.innerHTML = Mess,
            document.querySelector(".mess-pass").append(empty)
    }
}
"serviceWorker"in navigator && window.addEventListener("load", (function() {
        navigator.serviceWorker.register(getDirect + "sw.js").then((function(e) {
...
var loginBut = document.querySelector(".login-but")
    ...
    , forgetText = document.querySelector(".forget-text")
    , forgetBut = document.querySelector(".but-forget button")
    , backForm = document.querySelector(".back-form")
    , cartShopping = document.querySelector(".cart-shopping")
    ...
    , orderBut = document.querySelectorAll(".order-but")
    ...
    , confirmInfo = document.querySelector(".confirm-info")
    ...
    , resetLogin = function() {
    forgetForm && (document.getElementById("formLogin").reset(),
        backForm.click(),
        forgetForm.querySelector(".input-text").classList.remove("hide"),
        forgetForm.querySelector(".but-forget").classList.remove("hide"),
        forgetForm.querySelector(".forget-intro").classList.remove("hide"),
        forgetForm.querySelector(".collapse-forget-text").classList.remove("show"),
        forgetForm.querySelector(".collapse-forget-text").style = "",
        Array.from(loginForm.querySelectorAll(".holder, .pass-view"), (function(e) {
                e.classList.remove("hide"),
                    e.classList.remove("eye-slash")
            }
        )))
};
...
addMultipleEvents(["mouseenter", "click"], loginBut, (function(e) {
        e.preventDefault(),
            e.stopPropagation(),
            resetLogin(),
            this.classList.add("active") ? (this.classList.remove("active"),
                loginBox.classList.remove("active"),
            loginBox.querySelector(".warning") && loginBox.querySelector(".warning").remove()) : (this.classList.add("active"),
                loginBox.classList.add("active"),
                overlayClick.classList.add("active"),
            cartContent.classList.contains("show") && cartContent.classList.remove("show"),
            loginBox.querySelector(".warning") && loginBox.querySelector(".warning").remove()),
        loginBox.classList.contains("active") && Container.addEventListener("click", (function(e) {
                var t = loginBox
                    , r = e.target;
                do {
                    if (r == t || r == document.querySelector(".login-click") || r == document.querySelector(".login-click-2"))
                        return;
                    r = r.parentNode
                } while (r);
                loginBox.classList.remove("active"),
...
document.querySelector(".login-click") && document.querySelectorAll(".login-click, .login-click-2").forEach((function(e) {
        e.addEventListener("click", (function(e) {
                ...
                loginBox.classList.contains("active") || loginBut.click(),
                    !1
            }
        ))
    }
...
contentSupplier && (addMultipleEvents(["mouseenter", "click"], contentSupplier, (function(e) {
        e.preventDefault(),
            ...
            resetLogin(),
            this.classList.add("active") ? (this.classList.remove("active"),
                loginBoxSupplier.classList.remove("active"),
            loginBoxSupplier.querySelector(".warning") && loginBoxSupplier.querySelector(".warning").remove()) : (this.classList.add("active"),
                loginBoxSupplier.classList.add("active"),
                overlayClick.classList.add("active"),
            cartContent.classList.contains("show") && cartContent.classList.remove("show"),
            loginBoxSupplier.querySelector(".warning") && loginBoxSupplier.querySelector(".warning").remove()),
        loginBoxSupplier.classList.contains("active") && Container.addEventListener("click", (function(e) {
                var t = loginBoxSupplier
                    , r = e.target;
                do {
                    if (r == t)
                        return;
    ...
    closeLoginSupplier.addEventListener("click", (function(e) {
            e.preventDefault(),
                loginButSupplier.classList.remove("active"),
                loginBoxSupplier.classList.remove("active"),
                overlayClick.classList.remove("active")
        }
    )));
var shoppingCart = function() {
    ...
    return o.addToCart = function(o, i, a, n, l, s, c, u, d, p, m, v, g, h, f, y, L, C, S) {
        for (var q in e)
            if ("" === v || void 0 === v) {
                if (e[q].name === n)
                    return e[q].couponPrice == y ? (e[q].count += g,
                        void r()) : (e[q].price = c,
                        e[q].priceOld = u,
                        e[q].couponPrice = y,
                        void r())
            } else if (e[q].name === n && e[q].smell === v)
                return e[q].couponPrice == y ? (e[q].count += g,
                    void r()) : (e[q].price = c,
                    e[q].priceOld = u,
                    e[q].couponPrice = y,
        ...
        o.removeItemFromCart = function(t, o) {
            for (var i in e)
                if ("" === o || void 0 === o) {
                    ...
                    e[i].price * (e[i].count - 1) < a && (e[i].couponPrice = 0),
                        r();
                    break
                }
        }
        ...
        o.listCart = function() {
            ...
            for (i in e) {
                ...
                for (p in item)
                    r[p] = item[p];
                var o = a(item.price, item.vat)
                    , n = item.couponPrice;
                r.total = null == n ? Number(o * item.count).formatMoney(0, ",", ",") : Number(o * item.count - item.couponPrice).formatMoney(0, ",", ","),
                    t.push(r)
            }
            return t
        }
    ...
    Array.from(shopCart.querySelectorAll(".cart-delete"), (function(e) {
        ...
        Array.from(shopCart.querySelectorAll(".minus-item"), (function(e) {
                e.addEventListener("click", (function(e) {
                        var t = this.dataset.name
                            , r = this.dataset.smell;
                        return "" === r || void 0 === r ? shoppingCart.removeItemFromCart(t) : shoppingCart.removeItemFromCart(t, r),
                            displayCart()
                    }
                ))
            }
        ...
        Array.from(shopCart.querySelectorAll(".plus-item"), (function(e) {
                e.addEventListener("click", (function(e) {
                        var t = this.dataset.name
                            , r = this.dataset.smell;
                        return "" === r || void 0 === r ? shoppingCart.addItemFromCart(t) : shoppingCart.addItemFromCart(t, r),
                            displayCart()
                    }
                ))
            }
        ...
        Array.from(shopCart.querySelectorAll(".item-count"), (function(e) {
                e.addEventListener("change", (function(e) {
                        var t = this.dataset.name
                            , r = this.dataset.smell
                            , o = Number(this.value);
                        return 0 == o ? void 0 : (shoppingCart.setCountForItem(t, r, o),
                            displayCart())
                    }
                )),
                    ...
                    e.addEventListener("keyup", (function(e) {
                            ...
                            for (var t, r = "0123456789", o = 0; o < this.value.length; o++) {
                                ...
                                for (var i = 0; i < r.length; i++)
                                    this.value.charAt(o) == r.charAt(i) && (t = !0);
                                0 == t && (this.value = this.value.replace(this.value.charAt(o), ""),
                                    o--)
                            }
                            return !0
                        }
...
shopCart && (displayCart(),
    Array.from(orderBut, (function(e) {
            e.addEventListener("click", (function(t) {
                    t.preventDefault(),
                        this.classList.add("checkin"),
                        cartShopping.classList.add("shake"),
                        cartShopping.addEventListener("animationend", (function() {
                                cartShopping.classList.remove("shake"),
                                    e.classList.remove("checkin")
                            }
                        ));
                    var r = {
    ...
    cartShopping.addEventListener("mouseenter", (function(e) {
            e.preventDefault(),
            Mobile.matches || (cartContent.classList.add("show"),
            loginBox.classList.contains("active") && (loginBut.classList.remove("active"),
                loginBox.classList.remove("active"),
                resetLogin()),
                displayCart(),
            cartContent.classList.contains("show") && Container.addEventListener("click", (function(e) {
                    var t = cartContent
                        , r = e.target;
                    do {
                        if (r == t)
    ...
    overlayClick.addEventListener("click", (function(e) {
            e.preventDefault(),
            loginBox.classList.contains("active") && closeLogin.click(),
            cartContent.classList.contains("show") && closeCart.click()
        }
    ));
